...
public class AdminControlView implements AdminControlViewCallBack {
	...
	public String report(String reason, Post post, Wanderer wanderer) {
		return adminControlController.addReports(reason, post, wanderer);
	}

	private void reviewReports() {
		List<Report> reports = adminControlController.getReports();
	...
	private void deleteAuthor(Post post, Wanderer author) {
		String result = adminControlController.deleteAuthor(post, author);
		System.out.println(result);
	}

	private void deletePost(Post post, Wanderer author) {
		String result = adminControlController.deletePost(post, author);
		System.out.println(result);
