...
/**
 * Servlet implementation class FetchPostsWithName
 */
@WebServlet("/FetchPostsWithName")
public class FetchPostsWithName extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FetchPostsWithName() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int start = (page - 1) * 10;
		List<JobNotification> jobs = DB.getInstance().fetchFromPostedJobs(start, userID, title);
