	    ...
	    <nav>
	      <ul>
	          ...
	          <div class="search-bar" >
	            ...
	            <i onclick="search()" class="search-icon fas fa-search"></i>
	          </div>
	        </li>
	        <li><button class="nav-button" onclick="feed()">Home</button></li>
	        <li><button class="nav-button" onclick="callLetters()">Call Letters</button></li>
	        <li><button class="nav-button" onclick="appliedJobs()">Applied Jobs</button></li>
	      </ul>
	    </nav>
	  </header>
	</div>
