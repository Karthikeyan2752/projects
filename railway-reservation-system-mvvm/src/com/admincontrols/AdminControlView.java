...
public class AdminControlView {
	...
	private void viewAvailableTrains() {
		List<Train> trains = adminControlViewModel.viewAvailableTrains();
	...
	private void viewPassengerDetails() {
		List<Passenger> passengers = adminControlViewModel.viewPassengerDetails();
	...
	private void viewAvailableSeats() {
		...
		Train train = adminControlViewModel.viewAvailableSeats(name);
	...
	private void setupRailwayStation() {
		...
		adminControlViewModel.setupRailwayStation(location);
		displayControls();
	...
	private void addTrains() {
		...
		adminControlViewModel.addTrains(name, seats, depature, arrival, date);
		displayControls();
	...
	private void deleteTrains() {
		...
		String name = scanner.next();
		String result = adminControlViewModel.deleteTrains(name);
